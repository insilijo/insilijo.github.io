 ...
 * Only runs if jekyll-toc plugin didn't generate a TOC
 */
(function() {
  function generateTOC() {
    ...
    // Check if TOC was already generated by jekyll-toc plugin
    // Plugin generates a <nav> or <ul> structure, so if container has content, skip
    if (tocContainer.innerHTML.trim() !== '' && 
        (tocContainer.querySelector('nav') || tocContainer.querySelector('ul'))) {
      return; // TOC already generated by plugin
    }
