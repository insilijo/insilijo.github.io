...
related_posts: true
pretty_table: true
thumbnail: "assets/img/blogs/2026-04-21/Flag_of_Esperanto.svg.png"
---
...
{% include figure.liquid
  loading="eager"
  path="assets/img/blogs/2026-04-21/comb_of_lachish.jpg"
  caption="A bronze age ivory comb from Lachish, with a Canaanite inscription. https://commons.wikimedia.org/wiki/File:The_Canaanite_inscribed_ivory_comb_from_Lachish_1.jpg"
  alt="An ivory comb that was discovered in Lachish, and bears a mid to late bronze age inscription that expresses the holder's wish to eradicate lice. The inscription contains the earliest known complete sentence written in a phonetic alphabet, although some reseachers disagree with the reading of the insciption. The picture was taken when the comb was on display in Israel Museum (probably on a temporary display). This image was developed from raw format and denoised."
...
{% include figure.liquid
  loading="eager"
  path="assets/img/blogs/2026-04-21/stanley.jpg"
  caption="A corridor in The Stanley Hotel in Estes Park, Colorado, United States. Larry D. Moore. https://commons.wikimedia.org/wiki/File:Corridor_Stanley_Hotel_Estes_Park_Colorado_2024.jpg"
  caption_class="caption small"
%}
...
{% include figure.liquid
  loading="eager"
  path="assets/img/blogs/2026-04-21/zamenhof.jpg"
  caption="Portrait of L. L. Zamenhof. https://en.wikipedia.org/wiki/File:Zamenhof_portreto.jpg"
  figure_class="inline-figure inline-right"
  caption_class="caption small"
%}
