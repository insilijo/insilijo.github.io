...
related_posts: true
pretty_table: true
thumbnail: "assets/img/blogs/2026-02-22/dunkies.webp"
---

{% include figure.liquid
  loading="eager"
  path="assets/img/blogs/2026-02-22/dunkies_map.webp"
  caption="Google Maps screenshot of Dunkin' locations in downtown Boston. This in thumbnail image from https://www.boston.com/news/wickedpedia/2023/02/06/closest-two-dunkins-massachusetts/."  
...
These are not market failures. They do not mean that Bostonians are buying two mattresses a day, or [grabbing a cruller then an extra large and then three Parliaments](https://www.youtube.com/watch?v=FSvNhxKJJyU). These configurations are equilibria.
...
Drug development remains long-cycle and capital intensive, averaging roughly [$950 million](https://www.rand.org/news/press/2025/01/07.html) over [12-15 years](https://www.phrma.org/policy-issues/research-development) with single-digit-to-low-double-digit success probabilities. In restrictive funding environments, firms compete on two currencies: data and signal.
...
1. Firms that translated editing capability into validated therapeutic assets, and
2. Firms whose surface area expanded faster than their clinical maturation.
...
{% include figure.liquid
  loading="eager"
  path="assets/img/blogs/2026-02-22/gartner_hype_cycle.png"
  caption="Top AI Innovations in 2025, Gartner Hype Cycle. From https://bankingfrontiers.com/top-ai-innovations-in-2025-gartner/"
  caption_class="caption small"
%}
